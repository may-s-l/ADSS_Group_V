...
public class HRManagerEmployeeController {
    ...
    public ManagerEmployee createManagmentEmployee(String name, String ID, String bank_account, String branch, double vacationDay, String start_date, double salary, String job_type, String salary_type,String jobname){
        ...
        TermsOfEmployment terms=new TermsOfEmployment(vacationDay,date,salary,job_type,salary_type);
        ManagerEmployee NEWemployee=new ManagerEmployee(name,ID,bank_account,branch_to_emp,terms,job_to_emp);
        this.Temp_Database.getEmployees_temp_database().add(NEWemployee);
        return NEWemployee;
    ...
    public boolean UPDATEemployeeToManagmantEmployee(String ID,String job){
        ...
        if (empToUpdate!=null&&jobToUpdat!=null){
            if(empToUpdate instanceof ManagerEmployee){
               return false;
            }
            this.Temp_Database.getEmployees_temp_database().remove(empToUpdate);
            ManagerEmployee empToUpdateASmaneger =new ManagerEmployee(empToUpdate.getName(),ID,empToUpdate.getBank_account(),empToUpdate.getBranch(),empToUpdate.getTerms(),jobToUpdat);
